...
.dept-card:hover {
  ...
  background-color: rgb(103, 112, 62);
}
...
<main class="track-page">
  ...
  <h1 class="track-title" id="trackTitle">الــريــادة فــي الــطــاقــة والــصــنــاعــة</h1>
 
  <!-- Department Cards -->
  <div class="dept-grid">
 
    <a href="energy_computer_projects.php" class="dept-card">
      <img src="Energy_and_Industry.png" alt="قسم علوم الحاسب الآلي">
      <span id="dept1">قسم علوم الحاسب الآلي</span>
    </a>
 
    <a href="energy_physics_projects.php" class="dept-card">
      <img src="Energy_and_Industry.png" alt="قسم الفيزياء والطاقة المتجددة">
      <span id="dept2">قسم الفيزياء والطاقة المتجددة</span>
    </a>
 
    <a href="energy_english_projects.php" class="dept-card">
      <img src="Energy_and_Industry.png" alt="قسم اللغة الإنقليزية">
      <span id="dept3">قسم اللغة الإنقليزية</span>
    </a>
 
    <a href="energy_math_projects.php" class="dept-card">
      <img src="Energy_and_Industry.png" alt="قسم الرياضيات">
      <span id="dept4">قسم الرياضيات</span>
    </a>
 
    <a href="energy_kindergarden_projects.php" class="dept-card">
      <img src="Energy_and_Industry.png" alt="قسم الطفولة المبكرة">
...
function toggleLang() {
  ...
  setText("trackTitle", "الــريــادة فــي الــطــاقــة والــصــنــاعــة", "Innovation in Energy and Industry");
