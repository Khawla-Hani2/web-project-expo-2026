...
<main class="track-page">
  ...
  <h1 class="track-title"    id="trackTitle">قـسـم  الــطــفــولــة الــمــبــكــرة </h1>
...
function toggleLang() {
  ...
  setText("trackTitle",    "قـسـم  الــطــفــولــة الــمــبــكــرة ", "Kindergarten Department");
