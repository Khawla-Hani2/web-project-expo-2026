...
<main class="track-page">
  ...
  <h1 class="track-title" id="trackTitle"> الأبــحــاث الــعــلــمــيــة الــمــنــشــورة </h1>
 
  <!-- Department Cards -->
  <div class="dept-grid">
 
    <a href="research_computer_projects.php" class="dept-card">
      <img src="Research_Publications.png" alt="قسم علوم الحاسب الآلي">
      <span id="dept1">قسم علوم الحاسب الآلي</span>
    </a>
 
    <a href="research_physics_projects.php" class="dept-card">
      <img src="Research_Publications.png" alt="قسم الفيزياء والطاقة المتجددة">
      <span id="dept2">قسم الفيزياء والطاقة المتجددة</span>
    </a>
 
    <a href="research_english_projects.php" class="dept-card">
      <img src="Research_Publications.png" alt="قسم اللغة الإنقليزية">
      <span id="dept3">قسم اللغة الإنقليزية</span>
    </a>
 
    <a href="research_math_projects.php" class="dept-card">
      <img src="Research_Publications.png" alt="قسم الرياضيات">
      <span id="dept4">قسم الرياضيات</span>
    </a>
 
    <a href="research_kindergarden_projects.php" class="dept-card">
      <img src="Research_Publications.png" alt="قسم الطفولة المبكرة">
...
function toggleLang() {
  ...
  setText("trackTitle", " الأبحاث العلمية المنشورة ", "Published Scientific Research");
