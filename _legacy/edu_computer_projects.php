...
<main class="track-page">
  ...
  <h1 class="track-title"    id="trackTitle">قـسـم عـلـوم الحـاسـب الآلـي</h1>
...
function toggleLang() {
  ...
  setText("trackTitle",    "قـسـم عـلـوم الحـاسـب الآلـي",                                    "Computer Science Department");
