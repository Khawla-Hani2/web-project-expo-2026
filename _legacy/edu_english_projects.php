...
<main class="track-page">
  ...
  <h1 class="track-title"    id="trackTitle">قـسـم الـلـغـة الإنـقـلـيـزيـة</h1>
...
function toggleLang() {
  ...
  setText("trackTitle",    "قـسـم الـلـغـة الإنـقـلـيـزيـة",                                    "English Department");
