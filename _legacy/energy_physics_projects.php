...
.project-card {
  ...
  border-radius: 18px;
  overflow: hidden;
  box-shadow: 0 4px 20px rgba(128, 112, 50, 0.10);
...
.project-card:hover {
  ...
  box-shadow: 0 8px 32px rgba(128, 112, 50, 0.18);
}

.card-header {
  background-color: #807032;
  padding: 18px 22px;
  display: flex;
  align-items: center;
...
<main class="track-page">
  ...
  <h2 class="track-subtitle" id="trackSubtitle">مـشـاريـع مـسـار الـريـادة فـي الـطـاقـة والـصـنـاعـة</h2>
  <h1 class="track-title"    id="trackTitle">قـسـم الفيزياء والـطـاقـة الـمـتـجـددة</h1>
      ...
      <?php foreach ($projects as $project): ?>
        ...
        <div class="project-card">
          <div class="card-header">
            ...
            <img src="Energy_and_Industry.png" alt="<?= $projectName ?>">
          </div>
          <?php if ($hasPdf): ?>
          ...
          <div class="card-footer">
            ...
            <?php else: ?>
              <span style="font-family:'ExpoFont','Georgia',serif; color:#807032; font-size:0.9rem;" id="noFileLabel_<?= $project['id'] ?>">الملف غير متاح</span>
            <?php endif; ?>
          </div>
        </div>
      <?php endforeach; ?>
...
function toggleLang() {
  ...
  setText("trackSubtitle", "مـشـاريـع مـسـار الـريـادة فـي الـطـاقـة والـصـنـاعـة", "Energy and Industry Leadership Track Projects");
  setText("trackTitle",    "قـسـم الفيزياء والـطـاقـة الـمـتـجـددة",                           "Physics and Renewable Energy Department");
