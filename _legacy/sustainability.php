...
@media (max-width: 600px) {
  .track-title {
    font-size: 1.8rem; /* Title font size on mobile */
  }
 
  .track-subtitle {
    font-size: 1.1rem; /* Subtitle font size on mobile */
  }
 
  .dept-card {
    width: 120px;  /* Card width on mobile */
    height: 120px; /* Card height on mobile */
  }
 
  .dept-card img {
    width: 45px;  /* Image size on mobile */
    height: 45px;
  }
 
  .dept-card span {
    font-size: 0.72rem; /* Card text font size on mobile */
  }
}
</style>
...
<main class="track-page">
  ...
  <h1 class="track-title" id="trackTitle">اســتــدامــة الــبــيــئــة والإحــتــيــاجــات الأســاســيــة</h1>
 
  <!-- Department Cards -->
  <div class="dept-grid">
 
    <a href="env_computer_projects.php" class="dept-card">
      <img src="Environmental_Sustainability.png" alt="قسم علوم الحاسب الآلي">
      <span id="dept1">قسم علوم الحاسب الآلي</span>
    </a>
 
    <a href="env_physics_projects.php" class="dept-card">
      <img src="Environmental_Sustainability.png" alt="قسم الفيزياء والطاقة المتجددة">
      <span id="dept2">قسم الفيزياء والطاقة المتجددة</span>
    </a>
 
    <a href="env_english_projects.php" class="dept-card">
      <img src="Environmental_Sustainability.png" alt="قسم اللغة الإنقليزية">
      <span id="dept3">قسم اللغة الإنقليزية</span>
    </a>
 
    <a href="env_math_projects.php" class="dept-card">
      <img src="Environmental_Sustainability.png" alt="قسم الرياضيات">
      <span id="dept4">قسم الرياضيات</span>
    </a>
 
    <a href="env_kindergarden_projects.php" class="dept-card">
      <img src="Environmental_Sustainability.png" alt="قسم الطفولة المبكرة">
...
function toggleLang() {
  ...
  document.getElementById("expoLogo").src =
    lang === "ar"
    ? "assets/img/expo2026_ar_white.png"
    : "assets/img/expo2026_en_white.png";
  ...
  setText("trackTitle", "اسـتـدامـة الـبـيـئـة والإحـتـيـاجـات الأسـاسـيـة", "Sustainability and Basic Needs");
