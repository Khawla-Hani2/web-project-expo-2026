...
$stmt = $pdo->prepare("
  ...
  FROM projects
  WHERE track = 'Physics and Renewable Energy'
...
.project-card {
  ...
  border-radius: 18px;
  overflow: hidden;
  box-shadow: 0 4px 20px rgba(94, 41, 26, 0.10);
...
.project-card:hover {
  ...
  box-shadow: 0 8px 32px rgba(94, 41, 26, 0.18);
}

.card-header {
  background-color: #5E291A;
  padding: 18px 22px;
  display: flex;
  align-items: center;
...
<main class="track-page">
  ...
  <h2 class="track-subtitle" id="trackSubtitle">مـشـاريـع مـسـار الـتـعـلـيـم وتـنـمـيـة الـقـدرات الـبـشـريـة</h2>
  <h1 class="track-title"    id="trackTitle">قـسـم الـفـيـزيـاء والـطـاقـة الـمـتـجـددة</h1>
      ...
      <?php foreach ($projects as $project): ?>
        ...
        <div class="project-card">
          <div class="card-header">
            ...
            <img src="Education_and_Development.png" alt="<?= $projectName ?>">
          </div>
          <?php if ($hasPdf): ?>
          ...
          <div class="card-footer">
            ...
            <?php else: ?>
              <span style="font-family:'ExpoFont','Georgia',serif; color:#9a6050; font-size:0.9rem;" id="noFileLabel_<?= $project['id'] ?>">الملف غير متاح</span>
            <?php endif; ?>
          </div>
        </div>
      <?php endforeach; ?>
...
function toggleLang() {
  ...
  setText("trackSubtitle", "مـشـاريـع مـسـار الـتـعـلـيـم وتـنـمـيـة الـقـدرات الـبـشـريـة", "Education and Human Development Track Projects");
  setText("trackTitle",    "قـسـم الـفـيـزيـاء والـطـاقـة الـمـتـجـددة",                                    "Physics and Renewable Energy Department");
