...
.project-card {
  ...
  border-radius: 18px;
  overflow: hidden;
  box-shadow: 0 4px 20px rgba(119, 128, 142, 0.10);
...
.project-card:hover {
  ...
  box-shadow: 0 8px 32px rgba(119, 128, 142, 0.18);
}
...
<main class="track-page">
  ...
  <h2 class="track-subtitle" id="trackSubtitle">مـشـاريـع مـسـار الأبـحـاث الـعـلـمـيـة الـمـنـشـورة</h2>
      ...
      <?php foreach ($projects as $project): ?>
        ...
        <div class="project-card">
          <div class="card-header">
            ...
            <img src="Research_Publications.png" alt="<?= $projectName ?>">
          </div>
          <?php if ($hasPdf): ?>
          ...
          <div class="card-footer">
            ...
            <?php else: ?>
              <span style="font-family:'ExpoFont','Georgia',serif; color:#9aa0aa; font-size:0.9rem;" id="noFileLabel_<?= $project['id'] ?>">الملف غير متاح</span>
            <?php endif; ?>
          </div>
        </div>
      <?php endforeach; ?>
...
function toggleLang() {
  ...
  setText("trackSubtitle", "مـشـاريـع مـسـار الأبـحـاث الـعـلـمـيـة الـمـنـشـورة", "Published Scientific Research Track");
