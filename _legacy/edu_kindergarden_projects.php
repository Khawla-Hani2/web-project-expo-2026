...
<main class="track-page">
  ...
  <h1 class="track-title"    id="trackTitle">قـسـم الـطـفـولـة الـمـبـكـرة</h1>
...
function toggleLang() {
  ...
  setText("trackTitle",    "قـسـم الـطـفـولـة الـمـبـكـرة",                                    "Kindergarden Department");
